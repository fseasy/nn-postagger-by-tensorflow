...
def MlpNet(object):
    ...
    def build_net(self, batch_sz, window_sz, worddict_sz, embedding_dim, hidden_dim, tagdict_sz):
        with self.graph.as_default(), tf.device("/cpu:0"):
            ...
            with tf.name_scope("softmax"):
                ...
                batch_logits = tf.matmul(batch_hidden_out, w_o,transpose_b=True) + b_o
            ...
            self.batch_logits = batch_logits # for eval or predict
            self.loss = loss
